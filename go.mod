...
replace (
	...
	github.com/Shopify/sarama => github.com/weiwen12/sarama v1.29.2 //github.com/elastic/sarama v1.19.1-0.20210823122811-11c3ef800752
	...
	go.uber.org/zap => github.com/qshuai/zap v1.21.0
)
